...
def asignar_totales(datos):
    ...
    print("El total de los servicios a sido asignado existosamente.")
...
def menu():
    ...
    while True:
        ...
        if opcion == '1':
            ...
            if not datos:
                print("No hay lista de datos para filtar")
            else:
                tipo = input("Ingrese el tipo de servicio por el que desea filtrar: ").strip().lower()
                ...
                if datos:
                    servicios_ordenados = mostrar_servicio(datos)
                else:
                    print("No hay datos cargados.")
        elif opcion == "6":
            if servicios_ordenados:  
                guardar_archivo(servicios_ordenados)  
            else:
                print("Primero debe mostrar los servicios (opción 5) para poder guardarlos.")
        elif opcion == '7':
